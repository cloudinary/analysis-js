...
export class AIVisionModerationAnalysisData {
    'responses': Array<AIVisionModerationAnalysisDataResponsesInner>;
    'modelVersion'?: number;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "responses",
            "baseName": "responses",
            "type": "Array<AIVisionModerationAnalysisDataResponsesInner>"
        },
        {
            "name": "modelVersion",
    ...
    static getAttributeTypeMap() {
        return AIVisionModerationAnalysisData.attributeTypeMap;
    }
}

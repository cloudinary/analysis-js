...
export class AIVisionModerationAnalysisDataResponsesInner {
    'prompt'?: string;
    'value'?: AIVisionModerationAnalysisDataResponsesInner.ValueEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "value",
            "baseName": "value",
            "type": "AIVisionModerationAnalysisDataResponsesInner.ValueEnum"
        }    ];

    static getAttributeTypeMap() {
        return AIVisionModerationAnalysisDataResponsesInner.attributeTypeMap;
    }
}

export namespace AIVisionModerationAnalysisDataResponsesInner {
    export type ValueEnum = 'true' | 'false' | 'unknown';
    export const ValueEnum = {
        True: 'true' as ValueEnum,
        False: 'false' as ValueEnum,

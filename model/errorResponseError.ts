...
export class ErrorResponseError {
    'category'?: ErrorResponseError.CategoryEnum;
    'code'?: string;
    'message'?: string;
    'details'?: object;
    'requestId'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "category",
            "baseName": "category",
            "type": "ErrorResponseError.CategoryEnum"
        },
        {
            "name": "code",
            "baseName": "code",
...
export namespace ErrorResponseError {
    export type CategoryEnum = 'user_error' | 'auth_error' | 'server_error' | 'rate_limit_error';
    export const CategoryEnum = {
        UserError: 'user_error' as CategoryEnum,
        AuthError: 'auth_error' as CategoryEnum,
        ServerError: 'server_error' as CategoryEnum,
        RateLimitError: 'rate_limit_error' as CategoryEnum
    };
}

...
export class AnalyzeUriRequest {
    /**
    ...
    */
    'analysisType': AnalyzeUriRequest.AnalysisTypeEnum;
    'parameters'?: AnalyzeUriRequestParameters;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "AnalyzeUriRequest.AnalysisTypeEnum"
        },
        {
            "name": "parameters",
            "baseName": "parameters",
            "type": "AnalyzeUriRequestParameters"
        }    ];

    static getAttributeTypeMap() {
        return AnalyzeUriRequest.attributeTypeMap;
    }
}

export namespace AnalyzeUriRequest {
    export enum AnalysisTypeEnum {
        Captioning = <any> 'captioning',
        CldFashion = <any> 'cld_fashion',
        CldText = <any> 'cld_text',
        Coco = <any> 'coco',
        GoogleTagging = <any> 'google_tagging',
        HumanAnatomy = <any> 'human_anatomy',
        Lvis = <any> 'lvis',
        ShopClassifier = <any> 'shop_classifier',
        Unidet = <any> 'unidet',
        VqaTagging = <any> 'vqa_tagging',
        VqaModeration = <any> 'vqa_moderation',
        VqaGeneral = <any> 'vqa_general',
        Custom = <any> 'custom'
    }
}

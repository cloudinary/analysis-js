...
export class GoogleTaggingAnalysisDataLabelAnnotations {
    'labels'?: Array<GoogleTaggingAnalysisDataLabelAnnotationsLabelsInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "labels",
            "baseName": "labels",
            "type": "Array<GoogleTaggingAnalysisDataLabelAnnotationsLabelsInner>"
        }    ];

    static getAttributeTypeMap() {
        return GoogleTaggingAnalysisDataLabelAnnotations.attributeTypeMap;
    }
}

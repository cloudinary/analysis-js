...
export type Feature = 'google_tagging' | 'object_detection' | 'ai_vision';

export const Feature = {
    GoogleTagging: 'google_tagging' as Feature,
    ObjectDetection: 'object_detection' as Feature,
    AiVision: 'ai_vision' as Feature
};

...
export class AIVisionGeneralAnalysisData {
    'responses': Array<AIVisionGeneralAnalysisDataResponsesInner>;
    'modelVersion'?: number;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "responses",
            "baseName": "responses",
            "type": "Array<AIVisionGeneralAnalysisDataResponsesInner>"
        },
        {
            "name": "modelVersion",
    ...
    static getAttributeTypeMap() {
        return AIVisionGeneralAnalysisData.attributeTypeMap;
    }
}

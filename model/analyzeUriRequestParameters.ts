...
export class AnalyzeUriRequestParameters {
    'vqaTagging'?: VQATaggingParameters;
    'vqaModeration'?: VQAModerationParameters;
    'vqaGeneral'?: VQAGeneralParameters;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "vqaTagging",
            "baseName": "vqa_tagging",
            "type": "VQATaggingParameters"
        },
        {
            "name": "vqaModeration",
            "baseName": "vqa_moderation",
            "type": "VQAModerationParameters"
        },
        {
            "name": "vqaGeneral",
            "baseName": "vqa_general",
            "type": "VQAGeneralParameters"
        },
        {
            "name": "custom",
            "baseName": "custom",
    ...
    static getAttributeTypeMap() {
        return AnalyzeUriRequestParameters.attributeTypeMap;
    }
}

...
export class AnalyzeAIVisionTaggingRequestAllOf {
    'tagDefinitions': Array<AnalyzeAIVisionTaggingRequestAllOfTagDefinitions>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "tagDefinitions",
            "baseName": "tag_definitions",
            "type": "Array<AnalyzeAIVisionTaggingRequestAllOfTagDefinitions>"
        }    ];

    static getAttributeTypeMap() {
        return AnalyzeAIVisionTaggingRequestAllOf.attributeTypeMap;
    }
}

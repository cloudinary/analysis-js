...
*/
export type AnalysisType = 'captioning' | 'cld_fashion' | 'cld_text' | 'coco' | 'google_tagging' | 'human_anatomy' | 'lvis' | 'shop_classifier' | 'unidet' | 'ai_vision_tagging' | 'ai_vision_moderation' | 'ai_vision_general' | 'custom';

export const AnalysisType = {
    Captioning: 'captioning' as AnalysisType,
    CldFashion: 'cld_fashion' as AnalysisType,
    CldText: 'cld_text' as AnalysisType,
    Coco: 'coco' as AnalysisType,
    GoogleTagging: 'google_tagging' as AnalysisType,
    HumanAnatomy: 'human_anatomy' as AnalysisType,
    Lvis: 'lvis' as AnalysisType,
    ShopClassifier: 'shop_classifier' as AnalysisType,
    Unidet: 'unidet' as AnalysisType,
    AiVisionTagging: 'ai_vision_tagging' as AnalysisType,
    AiVisionModeration: 'ai_vision_moderation' as AnalysisType,
    AiVisionGeneral: 'ai_vision_general' as AnalysisType,
    Custom: 'custom' as AnalysisType
};

...
export class GoogleTaggingAnalysisData {
    'labelAnnotations': GoogleTaggingAnalysisDataLabelAnnotations;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "label_annotations",
            "type": "GoogleTaggingAnalysisDataLabelAnnotations"
        }    ];

    static getAttributeTypeMap() {
        return GoogleTaggingAnalysisData.attributeTypeMap;
    }
}

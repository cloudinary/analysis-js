...
export class AIVisionTaggingAnalysisData {
    'tags': Array<AIVisionTaggingAnalysisDataTagsInner>;
    'modelVersion'?: number;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "tags",
            "baseName": "tags",
            "type": "Array<AIVisionTaggingAnalysisDataTagsInner>"
        },
        {
            "name": "modelVersion",
    ...
    static getAttributeTypeMap() {
        return AIVisionTaggingAnalysisData.attributeTypeMap;
    }
}

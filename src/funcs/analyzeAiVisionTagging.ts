...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.AnalyzeAIVisionTaggingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/analyze/ai_vision_tagging")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeAiVisionTaggingResponse$inboundSchema),
    M.json(202, operations.AnalyzeAiVisionTaggingResponse$inboundSchema),

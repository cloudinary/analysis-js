...
> {
  ...
  const path = pathToFunc("/analyze/lvis")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeLvisResponse$inboundSchema),
    M.json(202, operations.AnalyzeLvisResponse$inboundSchema),

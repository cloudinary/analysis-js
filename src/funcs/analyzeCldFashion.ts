...
> {
  ...
  const path = pathToFunc("/analyze/cld_fashion")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeCldFashionResponse$inboundSchema),
    M.json(202, operations.AnalyzeCldFashionResponse$inboundSchema),

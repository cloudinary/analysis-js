 ...
 */
export function analyzeShopClassifier(
  client: CloudinaryAnalysisCore,
  request: components.BaseAnalyzeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AnalyzeShopClassifierResponse,
...
> {
  ...
  const path = pathToFunc("/analyze/shop_classifier")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeShopClassifierResponse$inboundSchema),
    M.json(202, operations.AnalyzeShopClassifierResponse$inboundSchema),

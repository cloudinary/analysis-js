...
> {
  ...
  const path = pathToFunc("/analyze/unidet")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeUnidetResponse$inboundSchema),
    M.json(202, operations.AnalyzeUnidetResponse$inboundSchema),

 ...
 */
export function analyzeAiVisionModeration(
  client: CloudinaryAnalysisCore,
  request: components.AnalyzeAIVisionModerationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AnalyzeAiVisionModerationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.AnalyzeAIVisionModerationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/analyze/ai_vision_moderation")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AnalyzeAiVisionModerationResponse$inboundSchema),
    M.json(202, operations.AnalyzeAiVisionModerationResponse$inboundSchema),

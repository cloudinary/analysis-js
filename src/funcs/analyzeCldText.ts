...
> {
  ...
  const path = pathToFunc("/analyze/cld_text")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AnalyzeCldTextResponse$inboundSchema),
    M.json(202, operations.AnalyzeCldTextResponse$inboundSchema),

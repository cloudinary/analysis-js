...
> {
  ...
  const path = pathToFunc("/analyze/coco")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AnalyzeCocoResponse$inboundSchema),
    M.json(202, operations.AnalyzeCocoResponse$inboundSchema),

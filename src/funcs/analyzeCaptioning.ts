...
> {
  ...
  const path = pathToFunc("/analyze/captioning")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeCaptioningResponse$inboundSchema),
    M.json(202, operations.AnalyzeCaptioningResponse$inboundSchema),

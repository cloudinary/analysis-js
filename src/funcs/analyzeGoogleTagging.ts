 ...
 */
export function analyzeGoogleTagging(
  client: CloudinaryAnalysisCore,
  request: components.BaseAnalyzeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AnalyzeGoogleTaggingResponse,
...
> {
  ...
  const path = pathToFunc("/analyze/google_tagging")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeGoogleTaggingResponse$inboundSchema),
    M.json(202, operations.AnalyzeGoogleTaggingResponse$inboundSchema),

...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.AnalyzeAIVisionGeneralRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/analyze/ai_vision_general")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyzeAiVisionGeneralResponse$inboundSchema),
    M.json(202, operations.AnalyzeAiVisionGeneralResponse$inboundSchema),
